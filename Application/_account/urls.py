...
from .models import get_accounttype_pk__account_id, get_account_list, get_account_list__accounttype_id

urlpatterns += [
    path('get_accounttype_pk__account_id/', get_accounttype_pk__account_id),
    path('get_account_list/', get_account_list),
    path('get_account_list__accounttype_id/', get_account_list__accounttype_id),
]